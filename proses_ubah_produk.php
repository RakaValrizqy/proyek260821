...
if($_POST){
    ...
    if(empty($nama_produk)) {
        ...
        $update=mysqli_query($conn,"update produk set nama_produk='".$nama_produk."',deskripsi='".$deskripsi."', harga='".$harga."', `foto produk`='".$foto_produk."', id_produk='".$id_produk."' where id_produk = '".$id_produk."' ") or die(mysqli_error($conn));
